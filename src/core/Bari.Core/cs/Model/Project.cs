...
namespace Bari.Core.Model
{
    ...
    public class Project: IProjectParametersHolder, IPostProcessorsHolder
    {
        ...
        public IInheritableProjectParameters GetInheritableParameters(string paramsName, IInheritableProjectParametersDef defs)
        {
            ...
            {
                return defs.CreateDefault(module.Suite, module.GetInheritableParameters(paramsName, defs));
            }
        }
        ...
        public void AddParameters(string paramsName, IProjectParameters projectParameters)
        {
            ...
            if (inheritableProjectParameters != null)
                parameters.Add(paramsName, inheritableProjectParameters.WithParent(module.Suite, module.GetInheritableParameters(paramsName, inheritableProjectParameters.Definition)));
            else
